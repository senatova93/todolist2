    ...
    render = () => {
        ...
        return (
            <div className="todoList-footer">
                ...
                {!this.state.isHidden && <span className= "span1" onClick= {this.onShowFiltersClick}>Hide</span>}
                { this.state.isHidden && <span className= "span1" onClick={this.onHideFiltersClick}>Show</span>}
            </div>
